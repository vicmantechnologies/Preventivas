...
$informacion=mysql_query("select * from revisiones where id_rev = '".$_GET["id_revision"]."'");

$row_informacion=mysql_fetch_array($informacion);

$datos_vehiculo=mysql_query("select * from info_vehiculos where placa = '".$row_informacion["placa"]."' limit 1");
...
if($row_informacion['tipo_revision']==1)
{
}
else
{
	//validamos el tipo de priueba
	if($row_informacion['tipo_revision']==4)//con gases
	{
		$gas=mysql_query("select * from resultados_gas where id_rel_rev_gas= '".$row_informacion['id_rev']."' limit 1");
		$sologas=true;
		$res_gas=mysql_fetch_array($gas);
	}
	if($row_informacion['tipo_revision']==5)//con opacidad
	{
		$opa=mysql_query("select * from resultados_opa where id_rel_rev_opa= '".$row_informacion['id_rev']."' limit 1");
		$soloopa=true;
		$res_opa=mysql_fetch_array($opa);
	}
	if($row_informacion['tipo_revision']==6)//con fas
	{
		$pista=mysql_query("select * from resultados_pista where id_rel_rev = '".$_GET["id_revision"]."'");
		$row_pista=mysql_fetch_array($pista);
		$solofas = true;
	}
	if($row_informacion['tipo_revision']==7)//prueba full
	{
		$pista=mysql_query("select * from resultados_pista where id_rel_rev = '".$_GET["id_revision"]."'");
		$row_pista=mysql_fetch_array($pista);
		$solofas = true;
		
		//buscamos si es gases o opacidad
		$gas=mysql_query("select * from resultados_gas where id_rel_rev_gas= '".$row_informacion['id_rev']."' limit 1");
		$row_gas=mysql_num_rows($gas);
		if($row_gas>0)//es gases
		{
			$sologas=true;
			$res_gas=mysql_fetch_array($gas);
		}
	...
	if($row_informacion['tipo_revision']==8)//solo luces
	{
		$sololuz=true;
		$luz=mysql_query("select * from resultados_luz where id_rel_rev_luz= '".$row_informacion['id_rev']."' limit 1");
		$res_luz=mysql_fetch_array($luz);
	}
}
?>
...
<table width="100%" border ="1" cellspacing="0" cellpadding="0" class="estilo1">
        ...
        <td width="15%">Modelo<br><?php echo $row_vehiculo['modelo']; ?></td>

        <td width="17%">Vencimiento SOAT<br><?php echo $row_vehiculo['fin_soat']; ?></td>

        <td width="16%">Vencimiento RTM<br><?php echo $row_vehiculo['fin_rtm']; ?></td>

        <td width="18%">Kilometraje<br><?php echo $row_informacion['kilometraje']; ?></td>

        <td width="9%">Combustible<br><?php 
        ...
        <td width="25%">Empresa<br><?php echo $row_informacion['empresa']; ?></td>
...

{
    ...
    B. RESULTADOS DE LA INSPECCIÓN</b></span><br>
...
<table width="98%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td align="center"><?php echo $res_luz[bd];?></td>

    <td>&nbsp;</td>

    <td>Klux</td>

    <td align="center"><?php echo $res_luz[id];?></td>
  ...
  <tr>
    ...
    <td align="center"><?php echo $res_luz[bi];?></td>

    <td>&nbsp;</td>

    <td>Klux</td>

    <td align="center"><?php echo $res_luz[ii];?></td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td align="center"><?php echo ($res_luz[bd]+$res_luz[bi]);?></td>
  ...
  <tr>
    ...
    <td width="18%"><table width="100%" border="0" class="estilo1">
      ...
      <tr>
        ...
        <td align="center"><?php echo $res_gas[cor];?></td>
      ...
      <tr>
        ...
        <td align="center"><?php echo $res_gas[coc];?></td>
    ...
    <td width="18%"><table width="100%" border="0" class="estilo1">
      ...
      <tr>
        ...
        <td align="center"><?php echo $res_gas[co2r];?></td>
      ...
      <tr>
        ...
        <td align="center"><?php echo $res_gas[co2c];?></td>
    ...
    <td width="18%"><table width="100%" border="0" class="estilo1">
      ...
      <tr>
        ...
        <td align="center"><?php echo $res_gas[o2r];?></td>
      ...
      <tr>
        ...
        <td align="center"><?php echo $res_gas[o2c];?></td>
    ...
    <td width="18%"><table width="100%" border="0" class="estilo1">
      ...
      <tr>
        ...
        <td align="center"><?php echo $res_gas[hcr];?></td>
      ...
      <tr>
        ...
        <td align="center"><?php echo $res_gas[hcc];?></td>
  ...
  <tr>
    ...
    <td width="18%"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td align="center"><?php echo $res_opa[ciclo1];?></td>
    ...
    <td width="18%"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td align="center"><?php echo $res_opa[ciclo2];?></td>
    ...
    <td width="18%"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td align="center"><?php echo $res_opa[ciclo3];?></td>
    ...
    <td width="18%"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td align="center"><?php echo $res_opa[ciclo4];?></td>
    ...
    <td width="18%"><table width="100%" border="0" class="estilo1" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td align="center">Resultado &nbsp;&nbsp;&nbsp; <?php 

		$suma=(($res_opa[ciclo2]+$res_opa[ciclo3]+$res_opa[ciclo4])/3);

		echo round($suma,1);?></td>
...
<tr>
	...
	for ($j = 0; $j < $count; $j++) {echo $piezas[$j].'<br>';}?></td>
...
<span class="estilo3"><b>NOMBRE DEL INSPECTOR: </b></span>
...
echo ''.$result_user['nombres'].'  '.$result_user['apellidos'];?> <BR>
...
-->   
   ...
   <table width="100%" border ="1" cellspacing="0" class="estilo1">
<tr>
	<td align="center"><img src='<?php echo $row_informacion['archivo']; ?>' border='0' width='400' height='240'>
	</td>
...
-	Revise su vehículo antes de ser retirado de nuestras instalaciones, no se aceptan reclamos una vez haya salido del Centro de diagnóstico.</td>
