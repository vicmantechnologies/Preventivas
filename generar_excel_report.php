...
//este reporte es solo para usuario preventivas que facturan
	...
	{
		?>
        	<form name="consulta_punto" class="iform2" method="POST"  action="excel_report.php" id="consulta_punto"  >

  		  <p align="center" class="Estilo1">EXPORTAR REGISTROS - SIPCO</p>
...
echo '<option value="'.$row_convenios['nombre'].'">'.$row_convenios["nombre"].'</option>';
}
echo '</select>';
