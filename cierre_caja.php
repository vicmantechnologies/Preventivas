...
{
	?>
	<script>window.open('reporte_general_ventas2.php?fecha_con1=<?php echo $_POST["fecha_con1"]?>&fecha_con2=<?php echo $_POST["fecha_con2"]?>&punto_venta=<?php echo $_POST["tipo"]?>', 'name', 'location=yes,menubar=no,status=no,toolbar=no,scrollbars=yes,width=840,height=480')</script>
    <?php
