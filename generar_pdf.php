...
{
	?>
	<script>window.open('export_range_pdf.php?fecha_con1=<?php echo $_POST["fecha_con1"]?>&fecha_con2=<?php echo $_POST["fecha_con2"]?>&empresa=<?php echo "".$_POST["empresa"].""?>', 'name', 'location=yes,menubar=no,status=no,toolbar=no,scrollbars=yes,width=840,height=480')</script>
    <?php
...
//este reporte es solo para usuario preventivas que facturan
	...
	if($row_generado["empresa"]=="PREVENTIVAS")
	{
		?>
  		  ...
  		  <p align="center" class="Estilo1">EXPORTAR PDF POR EMPRESA- SIPCO</p>
