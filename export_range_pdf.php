...
$query_rango="Select placa from revisiones WHERE fecha between '".$fecha_con1."' and '".$fecha_con2."' and empresa = '".$row_emp['nombre']."' and finalizado=1 order by id_rev asc";
