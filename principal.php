...
<div class="container">
  <div class="header"><a href="#"><img src="" alt="Insertar logotipo aquí" name="Insert_logo" width="7%" height="90" id="Insert_logo" style="background-color:#036;  display:block;" /></a> 
    <!-- end .header --></div>
  <div class="content">
  <?php $placa='CDA123'?>     
