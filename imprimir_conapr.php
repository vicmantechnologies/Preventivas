...
$informacion=mysql_query("select * from revisiones where id_rev = $id_revision");
$row_informacion=mysql_fetch_array($informacion);

$pista=mysql_query("select * from resultados_pista where id_rel_rev = $id_revision");
$row_pista=mysql_fetch_array($pista);

$datos_vehiculo=mysql_query("select * from info_vehiculos where placa like '".$row_informacion["placa"]."' limit 1");
...
<table width="100%" border ="1" cellspacing="0" cellpadding="0" class="estilo1">
        <tr>
        <td width="16%">Modelo<br><?php echo $row_vehiculo['modelo']; ?></td>
        ...
        <td width="11%">Combustible<br><?php 
		...
		{echo "ELECTRICO";}
		?></td>
        <td width="22%">Empresa<br><?php echo $row_informacion['empresa']; ?></td>
        </tr>
</table>
<!--
