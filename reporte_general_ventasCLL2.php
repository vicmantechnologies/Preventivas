    ...
    <tr>
        <td valign="top"><!--Coloco el cabezote en la parte superior-->
            <table border="1" width="100%" align="center" cellspacing="0" bordercolor="#000000" cellpadding="4">
                <tr>
                    <td rowspan="3" width="24%"><img src="imagenes/preventax.jpg" width="172" height="64"/></td>
                    <td rowspan="3" width="52%" align="center"><b><font face="Times New Roman, Times, serif">REPORTE
                                VENTAS GENERAL</font></b></td>
            ...
            <table border="0" width="100%" id="table1">
                ...
                <tr>
                    <td> <?php
                        ...
                        $result = "select * from revisiones where usuario ='" . $_SESSION['k_username'] . "' and fecha between '" . $fecha_con1 . "' and '" . $fecha_con2 . "' AND id_fac!=0 order by id_fac asc";
                        ...
                        echo "<tr><td align='center'>ID FACTURA</td><td align='center'>ID REVISION</td><td align='center'>PLACA</td><td align='center'>FECHA</td><td align='center'>EMPRESA</td><td align='center'>NOMBRE CLIENTE</td><td align='center'>TIPO REVISION</td><td align='center'>VALOR</td><td align='center'>USUARIO QUE REGISTRA</td></tr> \n";
...
//imprimimos info
                            echo '<tr><td align="center">' . $row["id_fac"] . '</td><td align="center">' . $row["id_rev"] . '</td><td align="center">' . $row["placa"] . '</td><td align="center">' . $row["fecha"] . '</td><td align="center">' . $row["empresa"] . '</td><td align="center">' . $row["nombres"] . '</td><td align="left">PREVENTIVA</td><td align="right">$ ' . $row["valor"] . '</td><td align="center">' . $row_usuario_fact["nombres"] . '</td></tr>';
