...
$informacion=mysql_query("select * from revisiones where placa = '".$_GET["placa_revision"]."' order by id_rev desc limit 1");
...
$datos_vehiculo=mysql_query("select * from info_vehiculos where placa = '".$row_informacion['placa']."'");
...
<table width="100%" border ="1" cellspacing="0" cellpadding="0" class="estilo1">
		...
		{ echo "DIESEL";}
		elseif($row_vehiculo[combustible] == 5)
...
-->   
   ...
   <tr>
	...
	if($row_informacion['archivo'] == "")

	{

		$Base64Img = base64_decode($row_informacion["image"]);



file_put_contents('image.jpg', $Base64Img);    

echo "<img src='image.jpg' alt='image' border='0' width='400' height='240' />";
