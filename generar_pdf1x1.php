...
{
	?>
	<script>window.open('prueba_pdf.php?fecha_con1=<?php echo $_POST["fecha_con1"]?>&fecha_con2=<?php echo $_POST["fecha_con2"]?>&empresa=<?php echo "".$_POST["empresa"].""?>', 'name', 'location=yes,menubar=no,status=no,toolbar=no,scrollbars=yes,width=420,height=200')</script>
    <?php
